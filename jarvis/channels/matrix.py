...
try:
    ...
    raise ImportError(
        "Matrix dependencies not installed. Run: pip install jarvis-ai[matrix]"
    ) from e

from jarvis.bus.events import OutboundMessage
from jarvis.channels.base import BaseChannel
from jarvis.config.paths import get_data_dir, get_media_dir
from jarvis.utils.helpers import safe_filename
