...
class _FakeBot:
    ...
    async def get_me(self):
        return SimpleNamespace(username="jarvis_test")
...
async def test_start_uses_request_proxy_without_builder_proxy(monkeypatch) -> None:
    ...
    monkeypatch.setattr("jarvis.channels.telegram.HTTPXRequest", _FakeHTTPXRequest)
    monkeypatch.setattr(
        "jarvis.channels.telegram.Application",
