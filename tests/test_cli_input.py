...
def mock_prompt_session():
    ...
    with patch("jarvis.cli.commands._PROMPT_SESSION", mock_session), \
         patch("jarvis.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("jarvis.cli.commands.PromptSession") as MockSession, \
         patch("jarvis.cli.commands.FileHistory") as MockHistory, \
